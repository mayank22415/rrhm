...
// nodePos = where the clickable dot/label appears (may be slightly offset from centroid
//           to avoid overlaps — especially in the dense North-East cluster)
...
export const INDIA_STATES = [
  // ── LADAKH (UT) ──────────────────────────────────────────────────────────────
  {
    ...
    zone: "North",
    voices: 8,
    nodePos: { x: 268, y: 58 },   // top-center of Kashmir region
  ...
  // ── PUNJAB ──────────────────────────────────────────────────────────────────
  {
    ...
    zone: "North",
    voices: 38,
    nodePos: { x: 140, y: 118 },   // moved left from 158
  ...
  // ── CHANDIGARH (UT) — dot moved above Punjab/Haryana border ─────────────────
  {
    id: "CH",
    name: "Chandigarh",
    capital: "Chandigarh",
    zone: "North",
    voices: 4,
    nodePos: { x: 172, y: 108 },   // moved up so it's separate from Punjab/HR
  ...
  // ── DELHI (UT) ───────────────────────────────────────────────────────────────
  {
    ...
    zone: "North",
    voices: 96,
    nodePos: { x: 200, y: 162 },   // moved slightly right of Haryana
  ...
  // ── SIKKIM ──────────────────────────────────────────────────────────────────
  {
    ...
    zone: "North-East",
    voices: 5,
    nodePos: { x: 458, y: 172 },   // pulled slightly left of Assam
  ...
  // ─── NORTH-EAST CLUSTER (7 states spread across 4 rows) ─────────────────────
  // All dots given distinct non-overlapping positions using an offset grid:
  // Row 1 (y≈152): AR
  // Row 2 (y≈178): AS
  // Row 3 (y≈202): ML, SK(separate above), NL
  // Row 4 (y≈228): TR, MN
  // Row 5 (y≈255): MZ
  // ────────────────────────────────────────────────────────────────────────────
  {
    ...
    zone: "North-East",
    voices: 6,
    nodePos: { x: 538, y: 148 },   // top-right, clearly above Assam
  ...
  },
  {
    ...
    zone: "North-East",
    voices: 5,
    nodePos: { x: 472, y: 215 },   // left col, row 3
  ...
  },
  {
    ...
    zone: "North-East",
    voices: 5,
    nodePos: { x: 556, y: 205 },   // right col, row 3
  ...
  },
  {
    ...
    zone: "North-East",
    voices: 5,
    nodePos: { x: 500, y: 238 },   // left col, row 4
  ...
  },
  {
    ...
    zone: "North-East",
    voices: 6,
    nodePos: { x: 552, y: 232 },   // right col, row 4
  ...
  },
  {
    ...
    zone: "North-East",
    voices: 5,
    nodePos: { x: 530, y: 260 },   // center, row 5 — clearly below Manipur/Tripura
  ...
  // ── GUJARAT ─────────────────────────────────────────────────────────────────
  {
    ...
    zone: "West",
    voices: 110,
    nodePos: { x: 110, y: 272 },   // moved left from 118 to avoid DD overlap
  ...
  // ── DADRA & NAGAR HAVELI AND DAMAN & DIU (UT) ───────────────────────────────
  {
    ...
    zone: "West",
    voices: 3,
    nodePos: { x: 138, y: 312 },   // moved right of Gujarat dot (was 119,308)
  ...
  // ── PUDUCHERRY (UT) ─────────────────────────────────────────────────────────
  {
    ...
    zone: "South",
    voices: 4,
    nodePos: { x: 335, y: 505 },   // moved right of TN dot (was 316,508)
  ...
  // ── LAKSHADWEEP (UT) ────────────────────────────────────────────────────────
  {
    ...
    zone: "South",
    voices: 2,
    nodePos: { x: 128, y: 510 },   // clearly left of Kerala
